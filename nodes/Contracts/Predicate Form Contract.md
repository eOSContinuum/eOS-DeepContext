...
- A Predicate SHOULD include `grounded_in::[[Vocabulary Diversity Is a Feature]]` when its Crescent section is a direct instance of the conviction that vocabulary diversity is load-bearing.
