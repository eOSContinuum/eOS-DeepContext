...
Enforces [[Decisions/Embed Citation Parenthetical in Reference Filenames]]↗ and [[Decisions/Disambiguate Reference Artifacts from Traditions]]↗.
...
Enforces [[Decisions/Keep URLs as Scalar Metadata, Not Predicates]]↗.
...
Enforces [[Decisions/Distinguish Adopted from Not-Adopted in References]]↗.
...
Enforces [[Decisions/Restrict References to Tight Artifact Clusters]]↗.
...
- grounded_in::[[Decisions/Embed Citation Parenthetical in Reference Filenames]]↗
  - Grounds the (Author, Year) parenthetical rule in the Filename pattern Requirement.

- grounded_in::[[Decisions/Disambiguate Reference Artifacts from Traditions]]↗
  - Grounds the artifact-descriptor rule in the Filename pattern Requirement.

- grounded_in::[[Decisions/Keep URLs as Scalar Metadata, Not Predicates]]↗
  - Grounds the URL preservation Requirement.

- grounded_in::[[Decisions/Distinguish Adopted from Not-Adopted in References]]↗
  - Grounds the Body shape Requirement's adopted-vs-not-adopted discipline.

- grounded_in::[[Decisions/Restrict References to Tight Artifact Clusters]]↗
